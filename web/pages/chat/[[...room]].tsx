...
const Chat: NextPage = () => {
  ...
  const [rooms, currentRoom, createRoom, roomWorkingError] = useRoomControl(`${room}`)
  ...
  return <div>
    <div style={{ display: "grid", gridTemplateColumns: "auto 220px 740px auto" }}>
      <div />
      <div>
        <div>
    ...
    <h2>create room</h2>
    <div>
      <input type="text" value={newRoomName} onChange={e => setNewRoomName(e.currentTarget.value)} />
    ...
    {roomWorkingError !== false ? roomWorkingError : null}
      ...
      <div>
        {currentRoom && userId && <ChatRoom room={currentRoom} userId={userId} />}
      </div>
    <div />
    </div>
  </div>
